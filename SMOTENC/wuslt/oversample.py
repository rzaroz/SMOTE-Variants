...
df = pd.read_csv(src)
df = df.drop(["Dir", "Flgs", "SrcAddr", "DstAddr", "Sport", "Dport", "SrcBytes", "DstBytes", "SrcGap", "DstGap", "SrcGap", "Trans", "TotPkts", "DstMac"], axis=1)
...
sm = SMOTENC(random_state=42, categorical_features=["SrcMac"])
...
X_res.to_csv("report/SMOTENC-wustl-ehms-2020.csv", index=False)
